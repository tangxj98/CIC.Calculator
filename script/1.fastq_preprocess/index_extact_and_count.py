#!/usr/bin/env python3 
# fastq data processing. Author: Matt.Bockol@mayo.edu
...
primer_constant_5prime_alpha_distance = 25

# the start of this sequence is found 5' of the primer index approximately 5 bases away
primer_constant_5prime_beta = "GCTAG"
primer_constant_5prime_beta_distance = 5
